...
class WishitemRepositoryImpl implements WishitemRepository {
  ...
  Future<List<Wishitem>> getWishitemList({required UserId userId}) =>
      _dataSource.getWishitemList(userId: userId);

  @override
  Future<Wishitem> getWishitem({required WishitemId wishitemId}) =>
      _dataSource.getWishitem(wishitemId: wishitemId);

  @override
  Future<void> createWishitem(Wishitem wishitem) =>
      _dataSource.createWishitem(wishitem);

  @override
  Future<void> updateWishitem({required Wishitem wishitem}) =>
      _dataSource.updateWishitem(wishitem: wishitem);

  @override
  Future<void> deleteWishitem({required WishitemId wishitemId}) =>
      _dataSource.deleteWishitem(wishitemId: wishitemId);
}
