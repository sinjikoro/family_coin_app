...
class TaskRepositoryImpl implements TaskRepository {
  ...
  @override
  Future<List<Task>> getTaskList({required Id userId}) => _dataSource.getTaskList(userId: userId);

  @override
  Future<Task> getTask({required Id taskId}) => _dataSource.getTask(taskId: taskId);

  @override
  Future<void> createTask(Task task) => _dataSource.createTask(task);

  @override
  Future<void> deleteTask({required Id taskId}) => _dataSource.deleteTask(taskId: taskId);
