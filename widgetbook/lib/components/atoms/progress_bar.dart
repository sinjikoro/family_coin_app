...
@widgetbook.UseCase(name: 'Progress 0%', type: ProgressBar)
...
@widgetbook.UseCase(name: 'Progress 50%', type: ProgressBar)
...
@widgetbook.UseCase(name: 'Progress 100%', type: ProgressBar)
